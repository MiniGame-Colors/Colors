        ...
        if(climb) {
            ...
            if(v != 0) {
                ...
                if (!hasClimbed) {
                    ...
                    //    player.transform.position = new Vector2(posX - marginX, player.transform.position.y);
                ...
                //        Mathf.Clamp(player.transform.position.y, marginY.x, marginY.y));
